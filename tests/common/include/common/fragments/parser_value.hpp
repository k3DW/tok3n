...
#ifndef K3_TOK3N_TESTS_COMMON_FRAGMENTS_PARSER_VALUE_HPP
#define K3_TOK3N_TESTS_COMMON_FRAGMENTS_PARSER_VALUE_HPP
...
template <detail::parser LHS>
struct parser_value_tag
{
...
template <auto lhs>
constexpr auto parser_value = parser_value_tag<std::remove_cvref_t<decltype(lhs)>>{};

} // namespace k3::tok3n::tests

#endif // K3_TOK3N_TESTS_COMMON_FRAGMENTS_PARSER_VALUE_HPP
