...
{
	ASSERT_PARSER_VALUE_TYPE(Joi1, char);
	ASSERT_PARSER_VALUE_TYPE(Joi2, char);
	ASSERT_PARSER_VALUE_TYPE(Joi3, char);
	ASSERT_PARSER_VALUE_TYPE(Joi4, char);
	ASSERT_PARSER_VALUE_TYPE(Joi5, char);
