...
{
    ASSERT_IS_PARSER(Joi_Oom_OC, JoinType, std::string_view);
    ASSERT_IS_PARSER(Joi_Oom_NC, JoinType, std::string_view);
    ASSERT_IS_PARSER(Joi_Oom_L, JoinType, std::string_view);
    ...
    ASSERT_IS_PARSER(Joi_Exa_OC, JoinType, std::string_view);
    ASSERT_IS_PARSER(Joi_Exa_NC, JoinType, std::string_view);
    ASSERT_IS_PARSER(Joi_Exa_L, JoinType, std::string_view);
}
