...
#define DEP_ASSERT_PARSER_VALUES_EQ(LHS_VALUE, RHS_VALUE, LHS_DISPLAY, RHS_DISPLAY)          \
	ASSERT((detail::parser<decltype(LHS_VALUE)>),                                            \
		"`" STR(LHS_DISPLAY) "` does not satisfy the detail::parser concept.");              \
	ASSERT((detail::parser<decltype(RHS_VALUE)>),                                            \
		"`" STR(RHS_DISPLAY) "` does not satisfy the detail::parser concept.");              \
...
#define DEP_ASSERT_PARSER_VALUES_NE(LHS_VALUE, RHS_VALUE, LHS_DISPLAY, RHS_DISPLAY)          \
	ASSERT_CONCEPT(detail::parser, decltype(LHS_VALUE));                                     \
	ASSERT_CONCEPT(detail::parser, decltype(RHS_VALUE));                                     \
