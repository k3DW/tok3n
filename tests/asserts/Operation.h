...
#define ASSERT_MODIFIER_CALLABLE_DEP_1_R(MOD, P, R, MOD_DISPLAY, P_DISPLAY, R_DISPLAY) \
	...
	ASSERT_CONCEPT_PARSER(decltype(R));                                                \
	ASSERT_PARSER_VALUES_DEP_EQ((MOD)(P), R, (MOD_DISPLAY)(P_DISPLAY), R_DISPLAY)
...
#define ASSERT_MODIFIER_MODULO_OPERABLE_DEP_R(P, MOD, R, P_DISPLAY, MOD_DISPLAY, R_DISPLAY) \
	...
	ASSERT_CONCEPT_PARSER(decltype(R));                                                     \
	ASSERT_PARSER_VALUES_DEP_EQ((P) % (MOD), R, (P_DISPLAY) % (MOD_DISPLAY), R_DISPLAY)
