...
struct Delimit
{
	...
	using result_for = std::conditional_t<KeepDelimiters::value,
		std::pair<std::vector<typename P::template result_for<value_type>>, std::vector<typename D::template result_for<value_type>>>,
		std::vector<typename P::template result_for<value_type>>
	>;
