...
{
	ASSERT_IS_PARSER(Oom1, OneOrMoreType, std::vector<Output>);
	ASSERT_IS_PARSER(Oom2, OneOrMoreType, std::vector<Output>);
	ASSERT_IS_PARSER(Oom3, OneOrMoreType, std::vector<Output>);
	ASSERT_IS_PARSER(Oom4, OneOrMoreType, std::vector<std::tuple<Output, Output>>);
}
