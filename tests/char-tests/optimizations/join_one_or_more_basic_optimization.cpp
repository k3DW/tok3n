...
TEST("join_one_or_more_basic", "one_or_more_parser<any_of_parser>")
{
    ...
    EXPECT_THAT(the_parser<Joi_Oom_OC> | FAILS_PARSING(" 12321321"));
    EXPECT_THAT(the_parser<Joi_Oom_OC> | SUCCEEDS_PARSING("12341321", "123", "41321"));
    EXPECT_THAT(the_parser<Joi_Oom_OC> | FAILS_PARSING("012341321"));
    ...
    EXPECT_THAT(the_parser<Joi_Oom_OC> | FAILS_PARSING(L" 12321321"));
    EXPECT_THAT(the_parser<Joi_Oom_OC> | SUCCEEDS_PARSING(L"12341321", L"123", L"41321"));
    EXPECT_THAT(the_parser<Joi_Oom_OC> | FAILS_PARSING(L"012341321"));
    ...
    EXPECT_THAT(the_parser<Joi_Oom_OC> | FAILS_PARSING(e<int>(" 12321321")));
    EXPECT_THAT(the_parser<Joi_Oom_OC> | SUCCEEDS_PARSING(e<int>("12341321"), e<int>("123"), e<int>("41321")));
    EXPECT_THAT(the_parser<Joi_Oom_OC> | FAILS_PARSING(e<int>("012341321")));
...
{
    EXPECT_THAT(the_parser<Joi_Oom_NC> | FAILS_PARSING("12321321"));
    EXPECT_THAT(the_parser<Joi_Oom_NC> | FAILS_PARSING("1232 1321"));
    EXPECT_THAT(the_parser<Joi_Oom_NC> | SUCCEEDS_PARSING(" 12321321", " ", "12321321"));
    EXPECT_THAT(the_parser<Joi_Oom_NC> | FAILS_PARSING("12341321"));
    EXPECT_THAT(the_parser<Joi_Oom_NC> | SUCCEEDS_PARSING("012341321", "0", "12341321"));

    EXPECT_THAT(the_parser<Joi_Oom_NC> | FAILS_PARSING(L"12321321"));
    EXPECT_THAT(the_parser<Joi_Oom_NC> | FAILS_PARSING(L"1232 1321"));
    EXPECT_THAT(the_parser<Joi_Oom_NC> | SUCCEEDS_PARSING(L" 12321321", L" ", L"12321321"));
    EXPECT_THAT(the_parser<Joi_Oom_NC> | FAILS_PARSING(L"12341321"));
    EXPECT_THAT(the_parser<Joi_Oom_NC> | SUCCEEDS_PARSING(L"012341321", L"0", L"12341321"));

    EXPECT_THAT(the_parser<Joi_Oom_NC> | FAILS_PARSING(e<int>("12321321")));
    EXPECT_THAT(the_parser<Joi_Oom_NC> | FAILS_PARSING(e<int>("1232 1321")));
    EXPECT_THAT(the_parser<Joi_Oom_NC> | SUCCEEDS_PARSING(e<int>(" 12321321"), e<int>(" "), e<int>("12321321")));
    EXPECT_THAT(the_parser<Joi_Oom_NC> | FAILS_PARSING(e<int>("12341321")));
...
TEST("join_one_or_more_basic", "one_or_more_parser<all_of_parser>")
{
    ...
    EXPECT_THAT(the_parser<Joi_Oom_L> | FAILS_PARSING(" 12321321"));
    EXPECT_THAT(the_parser<Joi_Oom_L> | SUCCEEDS_PARSING("12341321", "123", "41321"));
    EXPECT_THAT(the_parser<Joi_Oom_L> | FAILS_PARSING("012341321"));
    ...
    EXPECT_THAT(the_parser<Joi_Oom_L> | FAILS_PARSING(L" 12321321"));
    EXPECT_THAT(the_parser<Joi_Oom_L> | SUCCEEDS_PARSING(L"12341321", L"123", L"41321"));
    EXPECT_THAT(the_parser<Joi_Oom_L> | FAILS_PARSING(L"012341321"));
    ...
    EXPECT_THAT(the_parser<Joi_Oom_L> | FAILS_PARSING(e<int>(" 12321321")));
    EXPECT_THAT(the_parser<Joi_Oom_L> | SUCCEEDS_PARSING(e<int>("12341321"), e<int>("123"), e<int>("41321")));
    EXPECT_THAT(the_parser<Joi_Oom_L> | FAILS_PARSING(e<int>("012341321")));
