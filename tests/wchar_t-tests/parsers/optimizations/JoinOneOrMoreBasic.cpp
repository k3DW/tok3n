...
{
    ASSERT_IS_PARSER(Joi_Oom_OC, JoinFamily, Output<wchar_t>);
    ASSERT_IS_PARSER(Joi_Oom_NC, JoinFamily, Output<wchar_t>);
    ASSERT_IS_PARSER(Joi_Oom_L, JoinFamily, Output<wchar_t>);
}
